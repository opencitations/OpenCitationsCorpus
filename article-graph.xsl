...
<xsl:stylesheet xmlns:cito="http://purl.org/spar/cito/" xmlns:rdfs="http://www.w3.org/2000/01/rdf-schema#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:org="http://www.w3.org/ns/org#" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:skos="http://www.w3.org/2004/02/skos/core#" xmlns:foaf="http://xmlns.com/foaf/0.1/" xmlns:fabio="http://purl.org/spar/fabio/" xmlns:frbr="http://purl.org/vocab/frbr/core#" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xlink="http://www.w3.org/1999/xlink" version="2.0">
  ...
  <xsl:template match="article">
    ...
    <xsl:for-each select="back//ref-list/ref">
      ...
      <xsl:if test="(citation|element-citation|mixed-citation)">
        <node id="{$id}:{@id}">
          ...
          <data key="ctype">
            <xsl:choose>
              <xsl:when test="(citation|element-citation|mixed-citation)[1]/@publication-type">
                <xsl:value-of select="(citation|element-citation|mixed-citation)[1]/@publication-type"/>
              </xsl:when>
              <xsl:when test="(citation|element-citation|mixed-citation)[1]/@citation-type">
                <xsl:value-of select="(citation|element-citation|mixed-citation)[1]/@citation-type"/>
              </xsl:when>
              <xsl:otherwise>
          ...
          <xsl:choose>
            <xsl:when test="(citation|element-citation|mixed-citation)[@publication-type='other' or @citation-type='other' or not(@publication-type or @citation-type)]">
              <xsl:variable name="citation" select="(citation|element-citation|mixed-citation)[@publication-type='other' or @citation-type='other' or not(@publication-type or @citation-type)][1]"/>
            ...
            <xsl:when test="(citation|element-citation|mixed-citation)[@publication-type='book' or @citation-type='book']">
              <xsl:variable name="citation" select="(citation|element-citation|mixed-citation)[@publication-type='book' or @citation-type='book'][1]"/>
              <data key="title">
                <xsl:choose>
            ...
            <xsl:when test="(citation|element-citation|mixed-citation)[@publication-type='journal' or @citation-type='journal']">
              <xsl:variable name="citation" select="(citation|element-citation|mixed-citation)[@publication-type='journal' or @citation-type='journal'][1]"/>
