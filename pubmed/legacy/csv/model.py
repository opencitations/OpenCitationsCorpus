...
article_fields = (
    "group id xml_container ctype journal doi pmid pmc isbn pii  nihmsid full_citation year "
  ...
  + "reference_count uri in_oa_subset retracted patent_number provenance").split()
